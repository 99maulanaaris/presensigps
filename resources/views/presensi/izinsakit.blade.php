...
<div class="page-body">
    <div class="container-xl">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="{{ Request('nik') }}" id="nik" class="form-control" placeholder="Nis" name="nik">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="{{ Request('nama_lengkap') }}" id="nama_lengkap" class="form-control" placeholder="Nama Siswa" name="nama_lengkap">
                            </div>
                        </div>
                        <div class="col-3">
        ...
        <div class="row">
            <div class="col-12">
                <table class="table table-bordered" id="tableIzin">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Tanggal</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $d->student->kelas->nama }}</td>
                            <td>{{ $d->student->jurusan->nama_dept }}</td>
                            ...
                            <td>
                                @if ($d->file)
                                    <a href="{{ asset($d->file) }}" download class="badge text-bg-success">Download</a>
                                @else
                                    <div class="badge text-bg-danger">Kosong</div>
                                @endif
                            </td>
                            <td>
