...
<div class="section" id="user-section">
    ...
    <div id="user-detail">
        <div class="avatar">
            @if(!empty(Auth::guard('student')->user()->foto))
            <img src="{{ asset(Auth::guard('student')->user()->foto) }}" alt="avatar" class="imaged w64" style="height:60px">
            @else
            <img src="assets/img/sample/avatar/avatar1.jpg" alt="avatar" class="imaged w64 rounded">
            @endif
        </div>
        <div id="user-info">
            <h3 id="user-name">{{ Auth::guard('student')->user()->nama }}</h3>
            <span id="user-role">{{ Auth::guard('student')->user()->kelas->nama }}</span>
            <span id="user-role">({{ Auth::guard('student')->user()->jurusan->nama_dept }})</span>
        </div>
    </div>
</div>
    ...
    <div class="card">
        <div class="card-body text-center">
            <div class="list-menu">
                ...
                <div class="item-menu text-center">
                    <div class="menu-icon">
                        <a href="{{ route('peta') }}" class="orange" style="font-size: 40px;">
                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            <div class="iconpresence">
                                ...
                                <img src="{{ asset('uploads/absensi/'. $presensihariini->foto_in) }}" alt="" class="imaged w48">
                                @else
                        ...
                        <div class="presencecontent">
                            <div class="iconpresence">
                                @if ($presensihariini != null && $presensihariini->jam_out != null )
                                  <img src="{{ asset('uploads/absensi/'. $presensihariini->foto_out) }}" alt="" class="imaged w48">
                                @else
                                <ion-icon name="camera"></ion-icon>
                                @endif
                            </div>
                ...
                <ul class="listview image-listview">
                    ...
                    <li>
                        <div class="item">
                            ...
                            <div class="in">
                                <div>
                                    <b>{{ $d->student->nama }}</b><br>
                                    <small class="text-muted">{{ $d->student->kelas->nama }}</small>
                                </div>
