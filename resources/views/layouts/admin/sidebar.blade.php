<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        ...
        {{-- LOGO SISTEM PAKE LOGO SEKOLAH --}}
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
                <img src="/assets/img/logosmkti.png" width="110" height="32" alt=""
        ...
        <div class="navbar-nav flex-row d-lg-none">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <div class="dropdown-item" id="btn-logout">Logout</div>
                </div>
            </div>
        </div>
                    ...
                    <div class="dropdown-menu {{ request()->is(['karyawan', 'departemen', 'cabang']) ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                @hasrole(['Admin','Guru'])
                                <a class="dropdown-item {{ request()->is(['student','student/*']) ? 'active' : '' }}"
                                    href="{{ route('student.index') }}">
                                    Siswa/i
                                </a>
                                @endhasrole
                                @hasrole(['Admin'])
                                <a class="dropdown-item {{ request()->is(['teacher','teacher/*']) ? 'active' : '' }}"
                                ...
                                @hasrole(['Admin'])
                                <a class="dropdown-item {{ request()->is(['konfigurasi/lokasikantor']) ? 'active' : '' }}" href="/konfigurasi/lokasikantor">Sync Lokasi</a>
                                @endhasrole
                            </div>
                        </div>
                    </div>
