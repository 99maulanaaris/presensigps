    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('kelas.store') }}" method="POST" id="frmDepartemen">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="kode_kelas" class="form-control" placeholder="Kode Kelas" name="kode_kelas">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nama_kelas" value="" class="form-control" name="nama_kelas" placeholder="Nama Kelas">
                            </div>
                        </div>
                    </div>
    ...
    $(function() {
        ...
        $(".btn-edit").click(function() {
            ...
            $.ajax({
                ...
                $("#id").val(ress.data.id);
                $('#kode_kelas').val(ress.data.kode_kelas);
                $('#nama_kelas').val(ress.data.nama);
            })
        });
